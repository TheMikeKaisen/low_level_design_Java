...
// VIOLATION: here, withdrawal throw an exception ( which according to LSP, shouldn't have )
...
class BankClient {
    ...
    public void processTransactions() {
        for (Account acc : accounts) {
            ...
            // THE PROBLEM: a withdrawal on FixedTermAccount will throw an error.
            // BUT according to LSP, FixedTermAccount should act like the parent
            try {
                acc.withdraw(500);

...
// Solution: INTRODUCE AN ABSTRACT CLASS ( INTERFACE ) between main class (Client) and other classes with db operations.
// so now to delete or introduce new db we do not need to modify main class. This open close principle is also followed.

...
class Parent {
    // parent element is return Animal Object data type.
    // this enforces the child overrident getAnimal method to return either Animal data type or narrower data type to Animal
    // narrow means children or grand chlidren of Animal class
    // so, if there were any parent to Animal class, it cannot be returned in the child overriden method
